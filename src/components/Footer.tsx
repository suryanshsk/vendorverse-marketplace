    ...
    <footer className="border-t" style={{ background: "var(--surface)", borderColor: "var(--border-color)" }}>
      <div className="max-w-[1200px] mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <h4 className="font-display font-bold text-sm mb-4" style={{ color: "var(--text)" }}>Platform</h4>
          ...
          <div>
            <h4 className="font-display font-bold text-sm mb-4" style={{ color: "var(--text)" }}>Project</h4>
            <div className="flex flex-col gap-2">
          ...
          <div>
            <h4 className="font-display font-bold text-sm mb-4" style={{ color: "var(--text)" }}>Tech Stack</h4>
            <div className="flex flex-col gap-2">
              {techLinks.map((tech) => (
        ...
        <div className="mt-12 pt-8 border-t flex flex-col sm:flex-row items-center justify-between gap-4" style={{ borderColor: "var(--border-color)" }}>
