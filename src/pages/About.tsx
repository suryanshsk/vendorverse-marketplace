        ...
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-24">
            ...
            <div>
              ...
              <h2 className="font-display font-extrabold mb-6" style={{ fontSize: "var(--t-4xl)" }}>Built by students, powered by MERN.</h2>
              ...
              <div className="flex gap-10">
                {[
                  ...
                  <div key={s.label}>
                    <p className="font-display font-extrabold text-2xl" style={{ color: "var(--accent)" }}>{s.num}</p>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 gap-4 mb-4">
                {team.map((t) => (
                  <div key={t.name} className="p-5 rounded-card border transition-all duration-300 hover:-translate-y-1" style={{ background: "var(--surface)", borderColor: "var(--border-color)" }}>
                    <div className="flex items-center gap-4">
                      <div className="w-11 h-11 rounded-full flex items-center justify-center font-display font-bold text-sm" style={{ background: "var(--accent-glow)", color: "var(--accent)" }}>
                        {t.name.charAt(0)}
                      </div>
                      <div>
                        <p className="font-display font-bold">{t.name}</p>
                        <p className="text-xs" style={{ color: "var(--text-muted)" }}>Roll: {t.roll}</p>
                        <p className="text-xs font-medium" style={{ color: "var(--accent)" }}>{t.role}</p>
                      </div>
                    </div>
                  </div>
                ))}
              ...
              <div className="p-5 rounded-card border" style={{ background: "var(--surface)", borderColor: "var(--border-color)" }}>
                <p className="text-xs uppercase tracking-widest mb-2" style={{ color: "var(--text-dim)" }}>Supervisor</p>
                <p className="font-display font-bold">Mr. Amit Kumar Yadav</p>
                <p className="text-sm" style={{ color: "var(--text-muted)" }}>Professor CSE, NIET Greater Noida</p>
              </div>
            </div>
          </div>
          ...
          <div>
            <div className="text-center mb-16">
              ...
              <h2 className="font-display font-extrabold" style={{ fontSize: "var(--t-4xl)" }}>Future Enhancements</h2>
            </div>
